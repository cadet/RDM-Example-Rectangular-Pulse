...
# %% [markdown]
# (GRM_for_linear_LC)=
# # Elution of a rectangular pulse 
...
# <br><br>
# This work on the **General Rate Model (GRM)** for linear liquid chromatography was later adopted as a model problem to determine convergence benchmarks by:
# <br><br>
# **Leweke et al. (2018)**:  
